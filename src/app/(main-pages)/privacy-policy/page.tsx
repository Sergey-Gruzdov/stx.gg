  ...
  return (
    <>
      <section className="relative">
        <div className="before:content-[''] before:absolute before:inset-0 before:bg-top-gradient before:z-[-10]">
          <div className="container content py-32">
            ...
            Soweit auf unseren Seiten personenbezogene Daten (beispielsweise Name, Anschrift oder E-Mail-Adresse) erhoben werden, 
            erfolgt dies – soweit es möglich ist– immer auf freiwilliger Basis. Wir geben Ihre Daten ohne Ihre ausdrückliche Zustimmung nicht an Dritte weiter. 
            ...
            Sie können der Erhebung und Speicherung Ihrer Daten jederzeit <a href="http://tools.google.com/dlpage/gaoptout?hl=de" target="blank">widersprechen</a>.</p>
          </div>
        </div>
      </section>
    </>
